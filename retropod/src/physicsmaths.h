#ifndef _PHYSICSMATHS
#define _PHYSICSMATHS

#include <math.h>

/************************************\
*
*This file is an implementation of a 3d Vector class, a 3d Matrix class
*and a Quaternion class used for 3d rotation calculations.
*It is simply a collection of inline functions.
*
* IMPORTANT: I did not write this code: 
*    It's taken from the source for the book 'Physics For Game Developers' published by O'reilly.
*
\************************************/
...
inline	void 	Quaternion::gyro(void)
{
	//n*=1.0f;
}
