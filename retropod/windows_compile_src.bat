REM g++ -o ./dist_mac/RetroPod ./src/surface.cpp ./src/shadow.cpp ./src/Node.cpp ./src/Model.cpp ./src/Hovercraft.cpp ./src/Checkpoint.cpp ./src/Main.cpp -lglu32 -lopengl32 -framework GLUT -framework OpenGL -D GL_SILENCE_DEPRECATION
